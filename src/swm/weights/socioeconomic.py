...
def create_socio_swm(
    ...
    """
    logger.info(f"Creating Socioeconomic SWM — base: {type(base_w).__name__}, method: {method.value}, index: {index_col}")
    ...
    logger.info(f"Socioeconomic SWM created with {len(new_weights)} units")
